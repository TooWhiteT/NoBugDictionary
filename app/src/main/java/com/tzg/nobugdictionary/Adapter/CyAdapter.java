...
public class CyAdapter extends RecyclerView.Adapter {
    public SpeechSynthesizer mSpeechSynthesizer;
    private List<CyBean.ResultBean> Madapterlist;
    ...
    public void setMadapterlist(List<CyBean.ResultBean> list){
        Madapterlist = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder,final int i) {
        ...
        ((Holder)viewHolder).item_text.setText(Madapterlist.get(i).getPinyin());
        ((Holder)viewHolder).item_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //播放音频
                mSpeechSynthesizer = SpeechSynthesizer.getInstance();
                mSpeechSynthesizer.speak(Madapterlist.get(i).getPinyin());
            }
        });

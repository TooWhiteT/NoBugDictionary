...
public class BsAdapter extends RecyclerView.Adapter {
    public SpeechSynthesizer mSpeechSynthesizer;
    private List<BsBean.ResultBean.ListBean> Madapterlist;
    ...
    public void setMadapterlist(List<BsBean.ResultBean.ListBean> list){
        Madapterlist = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new BsAdapter.Holder(inflate);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder,final int i) {
        ((BsAdapter.Holder)viewHolder).item_text.setText(Madapterlist.get(i).getZi());
        ((BsAdapter.Holder)viewHolder).item_image.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ((BsAdapter.Holder)viewHolder).layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (MonItem != null){
